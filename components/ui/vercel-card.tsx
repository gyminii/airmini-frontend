	...
	return (
		<motion.div
			className={cn(
				...
				bordered &&
					"border border-secondary/[0.2] dark:border-secondary/[0.2] rounded-xl",
				className
			)}
		...
		>
			{showIcons && (
				<>
					<Icon
						className={cn(
							"absolute -left-3 -top-3 h-6 w-6 text-primary dark:text-white",
							iconClassName
						)}
					/>
					<Icon
						className={cn(
							"absolute -bottom-3 -left-3 h-6 w-6 text-primary dark:text-white",
							iconClassName
						)}
					/>
					<Icon
						className={cn(
							"absolute -right-3 -top-3 h-6 w-6 text-primary dark:text-white",
							iconClassName
						)}
					/>
					<Icon
						className={cn(
							"absolute -bottom-3 -right-3 h-6 w-6 text-primary dark:text-white",
							iconClassName
						)}
					/>
				</>
